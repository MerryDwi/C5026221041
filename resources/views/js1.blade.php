...
<head>
    ...
    <script>
        function showalert() {
            alert("Selamat ! anda mendapatkan park wonbin!!!");
        ...
        function changeText() {
            ...
            textBox.style.color = "red"; //mengubah warna font dari text box menjadi memiliki warna
            span.innerHTML = textBox.value;
            //innerHTML = mengubah text secara runtime
            //.value = membaca isi komponen form
            console.log("hurray sudah disni "); // membuka developer tools, lalu tambhkan teksnya
